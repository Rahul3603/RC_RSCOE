      ...
      <div className="bg-sky-400 mx-auto mt-0 w-full h-full">
        <Slider {...settings}>
          <div className="h-[100vh] bg-white">
            ...
            >
              <div className="w-full md:w-3/12 flex justify-center">
                <img
                  className="w-36 h-36 md:w-44 md:h-44 mt-20 lg:mt-0"
                  src={logo1}
                  alt="Rotaract Club"
                />
              </div>
              <div className="text-center w-full lg:w-6/12">
                <h1 className="text-[36px] sm:text-5xl md:text-6xl font-bold p-2 md:p-4 font-[Poppins] tracking-wider text-black pb-3">
                  ROTARACT CLUB
                </h1>
                ...
                <p className="mx-4 md:mx-8 lg:mx-0 text-sm md:text-base text-gray-700 text-center w-5/15 mt-4">
          ...
          {/* <div className="h-[100vh] bg-background">
            <div className="flex flex-col h-full lg:flex-row content-center items-center justify-evenly">
              <div className="w-full md:w-3/12 flex justify-center">
                <img
                  className="w-36 h-36 md:w-44 md:h-44 mt-20 lg:mt-0"
                  src={logo1}
